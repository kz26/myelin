...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT, 'main.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '@(gvozr84h%ta@7*ofssegpv3$*n6o6yq6n4(n*s@yyqc_cxd='
